...
def create_demo_claims():
    ...
    return [
        orm.Claim(id=uuid.uuid4(), claim_number="CLM-001", customer_name="John Smith", customer_email="john@example.com", policy_number="POL-2024-001", claim_type="Medical Reimbursement", amount=1250.00, incident_date=date(2024, 1, 15), incident_location="Seattle, WA", description="Routine checkup and lab work", decision_status="APPROVE", triage_label="STP", fast_lane_eligible=True, fraud_score=0.1, risk_score=0.15, confidence=0.95),
        ...
        orm.Claim(id=uuid.uuid4(), claim_number="CLM-008", customer_name="Jennifer Taylor", customer_email="jennifer@example.com", policy_number="POL-2024-008", claim_type="Medical Reimbursement", amount=890.00, incident_date=date(2024, 2, 3), incident_location="Chicago, IL", description="Physical therapy sessions", decision_status="APPROVE", triage_label="STP", fast_lane_eligible=True, fraud_score=0.1, risk_score=0.18, confidence=0.92),
        ...
        orm.Claim(id=uuid.uuid4(), claim_number="CLM-010", customer_name="Amanda White", customer_email="amanda@example.com", policy_number="POL-2024-010", claim_type="Medical Reimbursement", amount=450.00, incident_date=date(2024, 2, 8), incident_location="Boston, MA", description="Annual dental cleaning", decision_status="APPROVE", triage_label="STP", fast_lane_eligible=True, fraud_score=0.02, risk_score=0.05, confidence=0.97),
