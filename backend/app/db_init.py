...
2. Create all tables
3. Seed demo data if SEED_ON_STARTUP=true and tables are empty
"""
import uuid
...
def init_database(seed_on_startup: bool = False) -> bool:
    """Initialize database: create tables and optionally seed."""
    ...
    try:
        ...
        logger.info("db.init.create_all.done", message="All database tables created")
        
        # Step 3: Seed if enabled
        if seed_on_startup:
            seed_if_empty()
